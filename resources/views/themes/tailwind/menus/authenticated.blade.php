<div x-data="{ open: false }" class="flex h-full md:flex-1">        
    <div class="flex-1 hidden h-full space-x-8 md:flex">  
        <div class="relative inline-flex items-center px-1 pt-1 text-sm font-medium leading-5 text-gray-500 transition duration-150 ease-in-out border-b-2 border-transparent cursor-pointer  focus:outline-none focus:text-gray-700 focus:border-gray-300">
            <span>Welcome to the LandedCost.io Dashboard</span>   
        </div>
    </div>          
    ...
    <div class="flex sm:ml-6 sm:items-center">
        ...
        <div @click.away="open = false" class="relative flex items-center h-full ml-3" x-data="{ open: false }">
            ...
            <div
                ...
                <div class="bg-white border border-gray-100 shadow-md rounded-xl lc-menu" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
